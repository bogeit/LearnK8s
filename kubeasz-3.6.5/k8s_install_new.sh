...
# 变量定义
export release=3.6.5  # 支持k8s多版本使用,定义下面k8s_ver变量版本范围: v1.31.2 v1.30.1 v1.29.5 v1.28.10 v1.27.14 v1.26.15
export k8s_ver=v1.31.2  # | docker-tag tags easzlab/kubeasz-k8s-bin   注意: k8s 版本 >= 1.24 时，仅支持 containerd
rootpasswd=$1
netnum=$2
nethosts=$3
cri=$4
